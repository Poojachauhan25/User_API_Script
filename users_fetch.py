""" Task Description 
1. Use the GET method to call the following public API endpoint:
 https://jsonplaceholder.typicode.com/users
2. The API returns a list of users in JSON format. Loop through each user and display the
following details: • Name • Username • Email • City (from address.city)
